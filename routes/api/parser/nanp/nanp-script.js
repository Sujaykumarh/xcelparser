...
let nanp_filename = __dirname + '/nanp.xlsx';
...
exports.readFile = function () {
  ...
  //let workbook_numbers = new Excel.Workbook(); //UNUSED
...
exports.compareNumber = function (numbers_to_compare) {
  ...
  for (var i = 0; i < numbers_to_compare.length; i++) {
    ...
    regions.push(region);
    //console.log('number: ', number, ' REGION: ', region);
  }
  //console.log('numbers: ', numbers_to_compare.length, ' REGIONs: ', regions.length);
  return regions;
}
